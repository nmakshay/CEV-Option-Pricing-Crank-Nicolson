function [V_naught,Error,timerval_cnm,blsprice]=Table1(E,alpha,beta,r,T,S,style,luf,q,discretization,Nx1,Nx2,Nx3,Nx)
pkg load financial;
pkg load io;
tic;
...
[blsprice]=blsmeshng(E,alpha,r,T,S,style);
Error=abs(V_naught-blsprice);
disp(Error);
